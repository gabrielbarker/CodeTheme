...
exports.setSettingsFileToRandomTheme = function() {
    ...
    x.getRandomColourPalette()
        .then((colourStrings) => {
            ...
            settings["Visual Studio Dark"]["editor.tokenColorCustomizations"] = jsonEditorTheme;
            settings["Visual Studio Dark"]["workbench.colorCustomizations"] = jsonWorkbenchTheme;
...
exports.setSettingsToDefault = function() {
    ...
    settingsJSON["Visual Studio Dark"] = {}
    settingsJSON["Visual Studio Dark"]["editor.tokenColorCustomizations"] = {};
    settingsJSON["Visual Studio Dark"]["workbench.colorCustomizations"] = {};
...
exports.saveCurrentTheme = function(name) {
    ...
    if(uniqueName(name, savedThemesJSON)) {
        ...
        namedThemeJSON["settings"] = settingsJSON["Visual Studio Dark"];
...
exports.setThemeToSavedTheme = function(name) {
    ...
    savedThemesJSON.themes.forEach(t => 
        {
            if(t.name === name) {
                settings["Visual Studio Dark"] = t.settings;
                writeSettingsFile(settings);
                themeExists = true;
            }
        });
